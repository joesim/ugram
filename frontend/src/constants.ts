...
export type ADD_CHAT_MESSAGE = typeof ADD_CHAT_MESSAGE;

export const RECEIVE_CHAT_MESSAGES = "RECEIVE_CHAT_MESSAGES";
export type RECEIVE_CHAT_MESSAGES = typeof RECEIVE_CHAT_MESSAGES;
...
export type NEW_NOTIFICATION = typeof NEW_NOTIFICATION;
