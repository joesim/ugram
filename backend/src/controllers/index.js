...
module.exports = function(app) {
	...
	app.get('/users/:userId', isAuthenticated, isAuthorized, Users.readOne);
	...
	app.get('/users/:userId/pictures', isAuthenticated, isAuthorized, Pictures.readAllOfUser);
	app.get('/users/:userId/pictures/:pictureId', isAuthenticated, isAuthorized, Pictures.readOne);
